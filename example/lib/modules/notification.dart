                ...
                child: ListView(children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      bool enableIncomingNumber = await _blePlugin
                          .enableIncomingNumber(true);
                      setState(() {
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      bool enableIncomingNumber = await widget.blePlugin
                          .enableIncomingNumber(false);
                      setState(() {
                        _enableIncomingNumber = enableIncomingNumber;
                      });
                    },
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        bool state = await widget.blePlugin
                            .queryOtherMessageState;
                        setState(() {
                          _state = state;
                        });
                      }),
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        List<int> messageType = await widget.blePlugin
                            .queryMessageList;
                        setState(() {
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        String customizeVersion = await widget.blePlugin
                            .queryCustomizeVersion;
                        setState(() {
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () async {
                        String firmwareVersion = await widget.blePlugin
                  ...
                  ElevatedButton(
                      child: const Text('android:checkSupportQuickContact()'),
                      onPressed: () async {
                        _contactConfigBean =
                  ...
                  Text("_nameLength: $_nameLength"),
                  const Text("Before calling sendCallContactName, call checkSupportQuickContact to get the length of the contact name supported by the watch！"),
                  ElevatedButton(
                    child: const Text('android:sendCallContactName()'),
                    onPressed: () =>
                        widget.blePlugin.sendCallContactName("嘿嘿", _nameLength),
                  ),
                  Column(
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () =>
                            widget.blePlugin.setNotification([
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            NotificationBean notificationBean = await widget
                                .blePlugin.getNotification;
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          if (_messageType.isNotEmpty) {
                            List<int> list = List.filled(
                                _messageType.length, 0, growable: false);
                            list[2] = 1;
                            list[3] = 1;
                      ...
                      ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (notificationBean.isNew!) {
                              setState(() {
                                for (int i = 0; i <
                                    notificationBean.list!.length; i++) {
